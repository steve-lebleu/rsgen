...
class Generate {
    constructor() {
        ...
        this.TEMPLATES = [
            ...
            { name: 'subscriber', dest: 'subscribers', ext: 'ts' },
            { name: 'query-string.interface', dest: 'types/interfaces', ext: 'ts' },
            { name: 'request.interface', dest: 'types/interfaces', ext: 'ts' },
            { name: 'business.service', dest: '.', ext: 'ts' },
            { name: 'data-layer.service', dest: '.', ext: 'ts' },
        ...
        const tasks = new Listr([
            ...
            },
            {
                ...
                task: () => {
                    ...
                    data.splice(data.length - 2, 0, `  require(\'./0${file_util_1.getIndex() - 1}-${hyphen}-routes.e2e.test\');`);
...
Generate.description = 'Generate files for Typeplate project';
