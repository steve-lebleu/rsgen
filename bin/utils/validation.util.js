...
const isValidPathDestination = ({ ...args }) => {
    ...
    const path = target === '-r' || target === '--resources' ? `${process.cwd()}/src/api/resources/${string_util_1.toHyphen(name)}/` : `${process.cwd()}/src/api/core/models/${string_util_1.toHyphen(name)}.model.ts`;
    return {
